...
public class BowlingGameTest {
    ...
    @Test
    void when_ten_frame_with_spare() {
        // Given
        int[] numberOfHits = {10, 1, 9, 5, 3, 6, 4, 3, 6, 5, 5, 10, 10, 7, 2, 8, 2, 4};
    ...
    @Test
    void when_ten_frame_with_no_strike_or_spare() {
        // Given
        int[] numberOfHits = {10, 1, 9, 5, 3, 6, 4, 3, 6, 5, 5, 10, 10, 7, 2, 8, 1};
